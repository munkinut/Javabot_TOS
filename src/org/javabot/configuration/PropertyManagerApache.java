 ...
 */
public class PropertyManagerApache {
     ...
     */
    private static PropertyManagerApache propertyManager;

    /** Creates new PropertyManager */
    private PropertyManagerApache() {
     ...
     */    
    public static synchronized PropertyManagerApache getInstance() {
        if (propertyManager == null) propertyManager = new PropertyManagerApache();
