...
public class SecurityManager implements MyObserver, MyObservable {
    ...
    public SecurityManager() {
        ...
        SkimmerTask st = new SkimmerTask();
    ...
    public void addIgnore(String hostmask) {
        ...
        IgnoreTask it = new IgnoreTask(hostmask);
    ...
    private void takeAction(int floodType, String hostmask) {
        ...
        switch (floodType) {
            ...
            case FloodCounter.CHANMSG:
                ...
                break;
            default:
                throw new IllegalStateException("Unexpected value: " + floodType);
        }
    }
    ...
    private void kick(int floodType, String hostmask) {
        ...
        for (MyObserver obs : observers) {
            obs.notifyEvent(SecurityManager.FLOOD, floodType, hostmask);
        }
    }
    ...
    public void notifyEvent(int event) {
        if (event == SecurityManager.SKIM_FLOODERS) {
            this.skimFlooders();
        }
    }
    ...
    public void notifyEvent(int event, int type, String message) {
        if (event == SecurityManager.IGNORE) {
